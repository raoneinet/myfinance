...
export const SearchExpense = ({setModal}: any) => {
    ...
    return (
        <div className="px-5 py-5 w-full flex justify-end gap-3">
            <form onSubmit={handleSubmit(handleExpenseInsert)} className="flex gap-2 justify-end">
                <div className="flex items-center">
                    <img src="/assets/icons/search_icon.png" className="-mr-7"/>
                    <input {...register("search_expense")} className=" pl-8 py-3 border border-gray-300 rounded-lg" placeholder="Buscar valor..." />
                </div>
